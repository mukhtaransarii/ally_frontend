      ...
      <View className="bg-white shadow-xl rounded-xl p-3 border border-gray-200">
         <View className="flex-row items-center gap-2">
           ...
           <View className="flex-1">
             <View className="flex-row items-center gap-2">
                <Text className="font-semibold text-gray-900">{trip.user.name}</Text>
                {/* Gender icon */}
             ...
             <View className="flex-row items-center self-start bg-gray-100 px-2 py-1 rounded-lg">
               ...
               <Text className="ml-1 text-xs font-medium text-gray-500">{trip.distance} • </Text>
               <Text className="text-xs font-medium text-gray-500">{trip.duration}</Text>
             </View>
           </View>
        </View>
        ...
        <Text className="text-xs text-gray-400 mt-1">Location</Text>
         <View className="flex-row items-center gap-1 bg-gray-100 rounded-lg p-2">
           ...
           <Text numberOfLines={3} className="flex-1 text-xs text-gray-600 leading-none">{trip?.pickup.humanAddress.display_name ||"Fetching address..."}</Text>
         </View>
     </View>
