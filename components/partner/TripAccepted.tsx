...
export default function TripNotification() {
  ...
  return (
      <View className="p-4 flex justify-between gap-3 absolute top-0 bottom-0 left-0 right-0">
        {/* UPPER */}
        <View className="gap-3 bg-white rounded-xl shadow-xl p-4">
         ...
         <View className="bg-white p-4 rounded-lg">
          <View className='bg-white shadow-xl rounded-xl p-4 border border-gray-200'>
